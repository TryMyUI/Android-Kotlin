...
class UxCrowdGoodVotingViewModel (application: Application) : AndroidViewModel(application) {

    var uxCrowdVotingRepository : UxCrowdVotingRepository = UxCrowdVotingRepository(application)


    fun submitUxCrowdGoodVoting(jsonRequestString : JsonObject) : MutableLiveData<CommonModel> {
        return uxCrowdVotingRepository.submitUxCrowdGoodVotingMutableData(jsonRequestString)
    }
