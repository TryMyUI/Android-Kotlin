...
class UxCrowdRepository(application: Application) {
    ...
    fun submitUxCrowdMutableData(jsonRequest : JsonObject): MutableLiveData<CommonModel>{

        var call = apiInterface.postUXCrowdUserAnswers(jsonRequest)
