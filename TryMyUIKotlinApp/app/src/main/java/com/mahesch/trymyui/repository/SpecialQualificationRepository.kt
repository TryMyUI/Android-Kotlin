...
class SpecialQualificationRepository(application: Application) {
    ...
    fun postSpecCriteriaResponseMutableData(token: String,testId: String) : MutableLiveData<SpecialTechnicalModel>{

        var call = apiInterface.post_technical_criteria_response(token,testId)
